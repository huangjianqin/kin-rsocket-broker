...
public class RSocketEndpoint {
    ...
    public RSocketEndpoint(RSocketServiceProperties config,
        ...
        Set<ServiceLocator> exposedServices = requesterSupport.exposedServices().get();
    ...
    public Map<String, Object> info() {
        ...
        if (!upstreamClusters.isEmpty()) {
            info.put("upstreams", upstreamClusters.stream().map(upstreamCluster -> {
                ...
                LoadBalanceRequester loadBalanceRequester = upstreamCluster.getLoadBalanceRequester();
    ...
    private ServiceLocator getServiceLocator(String serviceName) {
        ...
        for (ServiceLocator serviceLocator : requesterSupport.exposedServices().get()) {
