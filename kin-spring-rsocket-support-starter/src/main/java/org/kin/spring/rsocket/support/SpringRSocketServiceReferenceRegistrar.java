...
class SpringRSocketServiceReferenceRegistrar implements ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        if (Objects.nonNull(annoAttrs)) {
            //扫描注解有@SpringRSocketServiceReference的接口
            registerScanner(importingClassMetadata, registry, annoAttrs,
                    importingClassMetadata.getClassName() + "#" + SpringRSocketServiceReferenceRegistryPostProcessor.class.getSimpleName());
        }
    }
    ...
    void registerScanner(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry, AnnotationAttributes annoAttrs, String beanName) {
        ...
        //@Import(SpringRSocketServiceReferenceRegistrar.class)的声明类package class path
